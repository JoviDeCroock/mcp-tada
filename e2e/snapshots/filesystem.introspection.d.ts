...
export type introspection = {
  "tools": {
     ...
     * @param args.dryRun Preview changes using git-style diff format
     */
    "edit_file": {
      "inputSchema": {
        "type": "object",
     ...
     * @param args.sortBy Sort entries by name or size
     */
     ...
     * @param args.tail If provided, returns only the last N lines of the file
     * @param args.head If provided, returns only the first N lines of the file
     */
    "read_file": {
      "inputSchema": {
        "type": "object",
     ...
     * @param args.paths Array of file paths to read. Each path must be a string pointing to a valid file within allowed directories.
     */
    "read_multiple_files": {
      "inputSchema": {
        "type": "object",
